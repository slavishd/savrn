...
- Identifies hidden clusters of people based on responses to continuous variables
...
- Profile membership as an unobserved categorical variable
...
- Completed 14 days of self-reported sleep measures each day upon awakening
...
- Bergman & Trost (2006). *The person-oriented versus the variable-oriented approach: Are they complementary, opposites, or exploring different worlds?*

- Collins & Lanza (2010). *Latent class and latent transition analysis: With applications in the social, behavioral, and health sciences.*

- Spurk et al. (2020). *Latent profile analysis: A review and “how to” guide of its application within vocational behavior research.*
